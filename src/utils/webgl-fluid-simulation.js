/* eslint-disable */
/* Copied and modified from https://github.com/PavelDoGreat/WebGL-Fluid-Simulation/blob/master/script.js 54ed78b00d7d8209790dd167dece747bfe9c5b88 */
'use strict';
export default function init(el) {
    if (!el) {
        console.log('ERR: FLUID ELEMENT NOT FOUND');
        return;
    }
    const canvas = el;
//   const canvas = document.getElementById('fluid-canvas');
  ...
  let backgroundImgUrl = 'LDR_LLL1_0.png';
...
`
  ...
  let ditheringTexture = createTextureAsync(backgroundImgUrl);
  ...
  function createTextureAsync(url) {
    ...
    // do not know it's usage and temporarily commented or will console error
    // image.src = url;
  ...
  const parentNode = canvas.parentElement ? canvas.parentElement : canvas;
